...
__all__ = ['lognorm', 'lognorm_columns', 'filter_pdna', 'calculate_lfcs', 'average_replicate_lfcs', 'group_pseudogenes',
           'average_gene_lfcs', 'get_roc_aucs']
...
def average_replicate_lfcs(lfcs, guide_col, condition_indices, sep='_', lfc_cols=None,
    ...
    long_lfcs = (lfcs.melt(id_vars=guide_col, value_vars=lfc_cols,
                 ...
                 .reset_index())
    long_lfcs[condition_name] = (long_lfcs[condition_name].str.split(sep, expand=True)
                                 [condition_indices].agg(sep.join, axis=1))
