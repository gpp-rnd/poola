...
We can do a gene set enrichment analysis using the package [stringdb](https://github.com/gpp-rnd/stringdb)

```
gene_hits = gene_lfcs[(gene_lfcs['z_scored_avg_lfc'] < 0) &
                      (gene_lfcs['z_scored_avg_lfc_fdr'] < 0.01)].copy()
genes = list(gene_hits['Annotated Gene Symbol'].unique())
start_string_map = datetime.datetime.now()
string_ids = stringdb.get_string_ids(genes)
end_string_map = datetime.datetime.now()
enrichment_df = stringdb.get_enrichment(string_ids.queryItem)
end_enrichment_df = datetime.datetime.now()
print('map time: ' + str(end_string_map - start_string_map))
print('enrichment time ' + str(end_enrichment_df - end_string_map))
```
    ...
    <ipython-input-58-878c23fa2c1f> in <module>
          3 genes = list(gene_hits['Annotated Gene Symbol'].unique())
          4 start_string_map = datetime.datetime.now()
    ----> 5 string_ids = stringdb.get_string_ids(genes)
          6 end_string_map = datetime.datetime.now()
          7 enrichment_df = stringdb.get_enrichment(string_ids.queryItem)


    ~/.conda/envs/poola/lib/python3.6/site-packages/stringdb/api.py in get_string_ids(identifiers, species, limit, echo_query, caller_identity)
         70     }
         71     results = requests.post(request_url, data=params)
    ---> 72     df = handle_results(results)
         73     return df
         74 


    ~/.conda/envs/poola/lib/python3.6/site-packages/stringdb/api.py in handle_results(results)
         36         return df
         37     else:
    ---> 38         raise ValueError(results.reason)
         39 
         40 
...
identifiers = genes[:2000]
request_url = stringdb.build_request_url("get_string_ids", output_format='tsv')
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>17</td>
      <td>9606</td>
      <td>TP53,FANCD1,BRCA1</td>
      <td>TP53,BRCA2,BRCA1</td>
      <td>3.650000e-09</td>
      <td>2.630000e-06</td>
    ...
    <tr>
      ...
      <td>5.280000e-10</td>
      <td>1.560000e-07</td>
      <td>(2020) DSS1 interacts with and stimulates RAD5...</td>
    </tr>
    <tr>
      <th>178</th>
      <td>PMID</td>
      ...
      <td>2.690000e-10</td>
      <td>1.560000e-07</td>
      <td>(2020) Prevalence of Inherited Mutations in Br...</td>
    </tr>
    <tr>
      <th>179</th>
      <td>PMID</td>
      ...
      <td>5.280000e-10</td>
      <td>1.560000e-07</td>
      <td>(2020) Contralateral Prophylactic Mastectomy i...</td>
    </tr>
    <tr>
      <th>180</th>
      <td>NetworkNeighborAL</td>
      <td>CL:12610</td>
      <td>3</td>
      <td>74</td>
      <td>9606</td>
      <td>FANCD1,FANCL,BRCA1</td>
      <td>BRCA2,FANCL,BRCA1</td>
      <td>2.340000e-07</td>
      <td>4.200000e-06</td>
      <td>Fanconi anemia pathway, and Homologous DNA Pai...</td>
    </tr>
    <tr>
      <th>181</th>
      <td>NetworkNeighborAL</td>
      ...
      <td>6.580000e-07</td>
      <td>4.200000e-06</td>
      <td>BRCA1-BARD1 complex, and Tower</td>
    </tr>
  </tbody>
</table>
